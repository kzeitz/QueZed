   ...
   public abstract class Program {
      ...
      */
      ...
      public void Run(string[] args) {
         ...
         // Here is the entry point back into "Your" program
      ...
      protected virtual void ConfigureLog() {
         ...
         // This handles the case that Log4Net doesn't properly cleanup date based rolling file appenders
         if (rootAppender is RollingFileAppender & Settings.Exists("logFileName")) {
