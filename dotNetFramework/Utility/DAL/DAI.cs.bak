...
namespace DAL {
	...
	[DatabaseSelect(System.Data.CommandType.Text, "SELECT @@SERVERNAME AS Server, DB_NAME() AS [Database], HOST_NAME() AS [Host], SUSER_NAME() AS [User]")]
	class Connection : DatabaseStore, IConnection {
		private IPrincipal originalPrincipal = null;

		[DatabaseField("Server", System.Data.SqlDbType.NVarChar, null)]
		private string serverName = string.Empty;
		[DatabaseField("Database", System.Data.SqlDbType.NVarChar, null)]
		private string databaseName = string.Empty;
		[DatabaseField("Host", System.Data.SqlDbType.NVarChar, null)]
		private string hostName = string.Empty;
		[DatabaseField("User", System.Data.SqlDbType.NVarChar, null)]
